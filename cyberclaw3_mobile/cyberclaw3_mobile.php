...
$MAX_ITERATIONS = 15;
$TOTP_SECRET_FILE = $BASE_DIR . '/.totp_secret';
...
$dry_run = false; $continue_id = null; $list_mode = false; $positional = [];
...
while (($a = array_shift($argv_copy)) !== null) {
    ...
    if ($a === '--help' || $a === '-h') {
        ...
        echo "Environment:\n";
        echo "  LUMO_AGENT_DIR   base dir for secret/log/sessions (default: script dir)\n";
